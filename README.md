# Introduction to FP in Scala [![Build Status](https://travis-ci.org/tmcgilchrist/introduction-to-fp-in-scala.svg?branch=travis_ci)](https://travis-ci.org/tmcgilchrist/introduction-to-fp-in-scala)
